...
def drq_parameters():
    parser = argparse.ArgumentParser("Data regularized Q")
    parser.add_argument("--algorithm", default='drq')

    parser.add_argument("--device", default=device, help="GPU or CPU")
    parser.add_argument("--seed", type=int, default=1, help="random seed")
    parser.add_argument("--env-name", type=str, default="cartpole_swingup")
    ...
    parser.add_argument("--actor_update_frequency", type=int, default=2, help="update rate")
    parser.add_argument("--critic_target_update_frequency", type=int, default=2, help="update rate")
    ...
    parser.add_argument("--init_random_steps", type=int, default=1000)
    ...
    parser.add_argument("--file_encoder_ac", type=str, default="drq_encoder_ac.pth")
    parser.add_argument("--file_encoder_cri", type=str, default="drq_encoder_cri.pth")
